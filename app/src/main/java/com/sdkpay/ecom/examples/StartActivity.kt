...
class StartActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val payments = mapOf<String, () -> Unit>(
            ...
            getString(R.string.start_paypal_payment) to { startPayment { mPaymentObjectProvider.getPayPalPayment() } },
            getString(R.string.start_alipay_payment) to { startPayment { mPaymentObjectProvider.getAlipayPayment() } },
            getString(R.string.start_wiretransfer_payment) to { startPayment { mPaymentObjectProvider.getWiretransferPayment() } },
            getString(R.string.start_p24_payment) to { startPayment { mPaymentObjectProvider.getP24Payment() } },
            getString(R.string.start_sofort_payment) to { startPayment { mPaymentObjectProvider.getSofortPayment() } },
